...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View) {
        when (v.id) {
            R.id.btnMyTrip -> i = Intent(this, MyTripActivity::class.java)
            R.id.btnMotivation -> i = Intent(this, SplashActivity::class.java)
            R.id.btnComponents -> i = Intent(this, ComponentsActivity::class.java)
            R.id.btnNewUser -> {
